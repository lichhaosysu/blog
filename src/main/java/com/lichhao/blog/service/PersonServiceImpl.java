package com.lichhao.blog.service;
...
import com.lichhao.blog.dao.PersonDao;
...
public class PersonServiceImpl implements PersonService {
	 ...
	 * 
	 * @see
	 * edu.ku.it.si.springjpaoracleexample.service.PersonService#findbyEmplid
	 * (java.lang.String)
	 */
	@Override
	...
	public void save(Person person) {
		...
		personDao.save(person); // Person object's emplid instance field will
								// now have a value
